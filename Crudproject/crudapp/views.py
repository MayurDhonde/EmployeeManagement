...
def add_emp(request):
    ...
    return render(request,'crudapp/add_emp.html', {'form':form, 'data':data})  
...
def update_emp(request,id):
    if request.method=='POST':
        ...
        return render(request,'crudapp/update_emp.html', {'fm':fm})  
...
def add_department(request):
    ...
    return render(request,'crudapp/add_department.html', {'form':form, 'data':data})  
...
def update_department(request,id):
    if request.method=='POST':
        ...
        return render(request,'crudapp/update_department.html', {'fm':fm})  
...
def add_salary(request):
    ...
    return render(request,'crudapp/add_salary.html', {'form':form, 'data':data})  
...
def update_salary(request,id):
    if request.method=='POST':
        ...
        return render(request,'crudapp/update_salary.html', {'fm':fm})  
...
def salary_report(request):
    ...
    return render(request, 'crudapp/salary_report.html', {'form': form, 'salary_data': salary_data})
